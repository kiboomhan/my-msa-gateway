...
//
//            log.info("Global Filter baseMessage: request{}", config.getBaseMessage());
//
...
//        };
        ...
        GatewayFilter filter = new OrderedGatewayFilter((exchange, chain) -> {
            ...
            log.info("Logging Filter baseMessage: request{}", config.getBaseMessage());
...
//        }, Ordered.HIGHEST_PRECEDENCE); // -> 우선순위 높게 실행
            }, Ordered.LOWEST_PRECEDENCE); // -> 우선순위 낮게 실행
        return filter;
    }
